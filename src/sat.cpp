...
sat_sentence sat_sentence::from_dimacs(istream& is){
    ...
    while(getline(is, line)){
        ...
        if(literals.size() <= 0){
            ...
            cerr << "line " << line_no << ": " << line << endl;
            cerr << literals[0] << endl;
            exit(1);
        }
...
void sat_sentence::to_dimacs(ostream& dimacs_file, string comment){
    dimacs_file << "c " << endl 
                << "c This file was generated by SAT ART " << endl
                << "c " << endl
                << "c " << comment << endl
                << "c " << endl
                << "p cnf " << num_variables() << ' ' << clauses.size() << endl;
    for(auto& cl : clauses){
        for(int lit : cl){
            dimacs_file << lit << ' ';
        }
